...
const initState = {
    ...
    posts:[
        {id:1,productId:1,name:'Womens burnt orange casual tee',postDaysLeft:1,likeCount:2,ref:'M1',sellRating:1,arrivalDaysLeft:4,rating:1,image:'/images/home/product_03.png',price:89.99,description:'Classic casual t-shirt for women on the move. \n' +
                '100% cotton.'},
        {id:2,productId:2,name:'Womens burnt orange casual tee',postDaysLeft:2,likeCount:1,ref:'M1',sellRating:1,arrivalDaysLeft:4,rating:1,image:'/images/home/product_05.png',price:89.99,description:'Classic casual t-shirt for women on the move. \n' +
                '100% cotton.'},
        {id:3,productId:3,name:'Womens burnt orange casual tee',postDaysLeft:3,likeCount:4,ref:'M1',sellRating:1,arrivalDaysLeft:4,rating:1,image:'/images/home/product_07.png',price:89.99,description:'Classic casual t-shirt for women on the move. \n' +
                '100% cotton.'},
        {id:4,productId:4,name:'Womens burnt orange casual tee',postDaysLeft:5,likeCount:3,ref:'M1',sellRating:1,arrivalDaysLeft:4,rating:1,image:'/images/home/product_12.png',price:89.99,description:'Classic casual t-shirt for women on the move. \n' +
                '100% cotton.'},
        {id:5,productId:5,name:'Womens burnt orange casual tee',postDaysLeft:6,likeCount:5,ref:'M1',sellRating:1,arrivalDaysLeft:4,rating:1,image:'/images/home/product_14.png',price:89.99,description:'Classic casual t-shirt for women on the move. \n' +
                '100% cotton.'},
        {id:6,title:'jane`s lookbook',btnValue:'view now',subtitle:'get the look for under £200!',text:'We invited actress Jane Marshall to join us \n' +
                ...
                'for a website and this is simply filler text.',image:'/images/lookbook/post_new1.png',},
...
'/backspace' +
                'Terms: No purchase necessary. Vouchers are non-transferable and no cash alternative is ofered. Competition is for members only.',image:'/images/lookbook/post_new2.png'},
        {id:8,productId:6,name:'Womens burnt orange casual tee',postDaysLeft:0,likeCount:0,ref:'M1',sellRating:1,arrivalDaysLeft:4,rating:1,image:'/images/home/product_16.png',price:89.99,description:'Classic casual t-shirt for women on the move. \n' +
                '100% cotton.'},
        {id:9,productId:7,name:'Womens burnt orange casual tee',postDaysLeft:12,likeCount:2,ref:'M1',sellRating:1,arrivalDaysLeft:4,rating:1,image:'/images/home/product_03.png',price:89.99,description:'Classic casual t-shirt for women on the move. \n' +
                '100% cotton.'},
        {id:10,productId:8,name:'Womens burnt orange casual tee',postDaysLeft:15,likeCount:10,ref:'M1',sellRating:1,arrivalDaysLeft:4,rating:1,image:'/images/home/product_12.png',price:89.99,description:'Classic casual t-shirt for women on the move. \n' +
                '100% cotton.'},
        {id:11,productId:9,name:'Womens burnt orange casual tee',postDaysLeft:22,likeCount:22,ref:'M1',sellRating:1,arrivalDaysLeft:4,rating:1,image:'/images/home/product_14.png',price:89.99,description:'Classic casual t-shirt for women on the move. \n' +
                '100% cotton.'},
    ],
    products:[
        {id:1,availability:true,colors:['beige','green'],sizes:['40','42','43','45'],about:{text:'Donec sem lorem laoreet tempor un risus vitae, rutrum sodales nibh suspendisse est congue metus nunc, id viverra elit loreti rhoncus quis consecteur es. Donec pulvinar tempor lorem a pretium justo interdum.',list:['Elasticated cuffs','Casual fit','100% Cotton','Free shipping with 4 days delivery']},type: {sex:'mens',clothes: {type:'casual',name:'Jackets'}},name:'awe classic sweatshirt',sellRating:1,arrivalDaysLeft:4,rating:5,image:'/images/home/product_03.png',price:89.99,subtitle:'Classic casual t-shirt for women on the move. \n' +
